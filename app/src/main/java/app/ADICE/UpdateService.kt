...
const val UPDATE_AVAILABLE_INTENT = "app.ADICE.UPDATE_AVAILABLE_INTENT"
...
class UpdateService : IntentService("UpdateService") {
    ...
    companion object {
        ...
        private val API_URI = "repos/dbrodie/ADICE/releases"

        private val ACTION_FETCH_SERVER_VERSION = "app.ADICE.action.FETCH_SERVER_VERSION"
        private val ACTION_DOWNLOAD_UPDATE = "app.ADICE.action.DOWNLOAD_UPDATE"
        private val ACTION_INSTALL_UPDATE = "app.ADICE.action.INSTALL_UPDATE"

        val EXTRA_NEW_VERSION_INFO = "app.ADICE.extra.NEW_VERSION_INFO"
        private val EXTRA_NEW_VERSION_URL = "app.ADICE.extra.NEW_VERSION_URL"
        private val EXTRA_NEW_VERSION_LOCAL_URI = "app.ADICE.extra.NEW_VERSION_LOCAL_URI"
